...
<body>
    ...
    <div class="stu_portal">
        ...
        <h2
            style="font-weight: bold; position: absolute; right: -16em; top: -1em; font-size: 140%; color: white; text-wrap: nowrap;">
            Dr. Jose P. Rizal Senior High School Portal</h2>
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="username" placeholder="Enter username"
                                style="top: -30px; position: relative;" title="Please enter a correct username"
                                required>
                        </div>
                        <div class="form-group">
    ...
    <div class="container-form-right" style="right: 18%; height: 52%;">
        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    ...
                    <div class="linerist"
                        style="background-color: #0e6cc4; height: 3px; border-radius: 5px; top: -115%; position: relative;">
                    </div>
                    <!-- Placeholder News -->
                    <div class="news">
                        <div class="news-item" style="position: absolute; top: 30%;">
                            <h5>Important Announcement</h5>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                        </div>
                        <div class="news-item" style="position: absolute; top: 200%;">
