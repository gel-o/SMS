...
<body>
    <div class="container">
        ...
        <div class="course">
            ...
            <p class="acad">Accountancy, Business and Management <br><br>
                            Humanities and Social Science</p>
            <h6>Technical Vocational and Livelihood</h6>
            <p class="tvl">Cookery, Bread & Pastries, & Food Beverages <br><br>
                            Computer System Servicing <br><br>
                            Electrical Installation Maintenance <br><br>
                            Technical Drafting & Illustration</p>
        </div>
